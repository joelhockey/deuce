...
function testaction() {
	...
	var results2 = { msgtype: "results", results: [{ id: "gp_extauth", apdus: ["9000"] }, { id: 0, apdus: ["08a000000018434d00019e9000", "6a88", ""] }] };
    var actions3 = LIB.action.getActions(id, results2);
print(JSON.stringify(actions3))
}
